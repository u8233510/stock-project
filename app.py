...
from modules import data_browser, tech_analysis, branch_analysis, stock_health, data_management, prediction, fundamental_analysis, branch_anomaly, winner_branch_system, branch_flow_scanner
##--- 頁面配置 ---
...
main_menu = st.sidebar.radio(
    ...
    [
        ...
        "🔮 股價趨勢預測",
        "💎 基本面分析",
        "⚙️ 資料同步管理", # 含日線/分鐘/FinMind分點明細同步入口
        "🧪 策略回測 (開發中)",
        "⚙️ 系統設定"
    ],
    index=3 # 預設選中診斷頁面
...
elif main_menu == "🔍 分點每日買賣掃描":
    branch_flow_scanner.show_branch_flow_scanner()
